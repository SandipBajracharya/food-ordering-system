  ...
  <body class="p-2" style="font-size: 16px !important; color: rgb(100, 100, 100) !important; font-family:Arial, Helvetica, sans-serif;">
    <div class="outer-card card" style="background-color: rgb(245, 245, 245); border-radius: 0px !important; padding: 2rem 7rem;">
        <div class="inner-card card" style="border-radius: 0px !important; padding: 3rem 3.5rem; width: 100%; background-color: #fff;">
            ...
            <div class="w-100">
                <h1>Hello {{$fullname ?? "Sir/Ma'am"}},</h1>
            </div>
                ...
                <table class="" style="width: 100%; border: 2px solid #cecece;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="font-size: 13px; color: rgb(70, 70, 70); padding: 10px !important; border-bottom: 1px solid #cecece;"> {{$fullname}} </td>
                        </tr>
                        <tr>
                            ...
                            <td style="font-size: 13px; color: rgb(70, 70, 70); padding: 10px !important; border-bottom: 1px solid #cecece;"> 9808289788 </td>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        @if(isset($cart))
                            ...
                            <tr>
                                ...
                                <td style="border-bottom: 1px solid #cecece; border-right: 1px solid #cecece; font-size: 13px; color: rgb(70, 70, 70); padding: 10px !important; width: 12%;">1</td>
                                <td style="border-bottom: 1px solid #cecece; font-size: 13px; color: rgb(70, 70, 70); padding: 10px !important;">{{ $cart->amount ?? ''}}</td>
                            </tr>
                            @endforeach
                            @endif
                        @endif
                        ...
                        <tr>
                            ...
                            <td style="border-bottom: 1px solid #cecece; font-size: 13px; color: rgb(70, 70, 70); padding: 10px !important;"> - </td>
                        </tr>
                        <tr>
                            ...
                            <td style="font-size: 13px; color: rgb(70, 70, 70); padding: 10px !important;"> {{$cart->amount ?? ''}} </td>
                        </tr>
                    </tbody>
                </table>
            </div>
